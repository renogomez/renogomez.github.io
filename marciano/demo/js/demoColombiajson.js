...
var CO_States = { 
  ...
  index_name: {},
  data: [
            {code: 'CO01', id:01, name: 'AMAZONAS' }, 
            {code: 'CO02', id:02, name: 'ANTIOQUIA' }, 
            {code: 'CO03', id:03, name: 'ARAUCA' }, 
            {code: 'CO04', id:04, name: 'ATLANTICO' },
            {code: 'CO05', id:05, name: 'BOLIVAR'  },
            {code: 'CO06', id:06, name: 'BOYACA' }, 
            {code: 'CO07', id:07, name: 'CALDAS' }, 
            {code: 'CO08', id:08, name: 'CAQUETA' }, 
            {code: 'CO09', id:09, name: 'CASANARE' }, 
            {code: 'CO10', id:10, name: 'CAUCA' }, 
            {code: 'CO11', id:11, name: 'CESAR' }, 
            {code: 'CO12', id:12, name: 'CHOCO' }, 
            {code: 'CO13', id:13, name: 'CORDOBA' }, 
            {code: 'CO14', id:14, name: 'CUNDINAMARCA' }, 
            {code: 'CO15', id:15, name: 'GUAINIA' }, 
            {code: 'CO16', id:16, name: 'GUAVIARE' }, 
            {code: 'CO17', id:17, name: 'HUILA' }, 
            {code: 'CO18', id:18, name: 'LA GUAJIRA' }, 
            {code: 'CO19', id:19, name: 'MAGDALENA' }, 
            {code: 'CO20', id:20, name: 'META' }, 
            {code: 'CO21', id:21, name: 'NARIÑO' }, 
            {code: 'CO22', id:22, name: 'NORTE DE SANTANDER' }, 
            {code: 'CO23', id:23, name: 'PUTUMAYO' }, 
            {code: 'CO24', id:24, name: 'QUINDIO' }, 
            {code: 'CO25', id:25, name: 'RISARALDA' }, 
            {code: 'CO26', id:26, name: 'ARCHIPIELAGO DE SAN ANDRES PROVIDENCIA Y SANTA CATALINA' }, 
            {code: 'CO27', id:27, name: 'SANTANDER' }, 
            {code: 'CO28', id:28, name: 'SUCRE' }, 
            {code: 'CO29', id:29, name: 'TOLIMA' }, 
            {code: 'CO30', id:30, name: 'VALLE DEL CAUCA' }, 
            {code: 'CO31', id:31, name: 'VAUPES' }, 
            {code: 'CO32', id:32, name: 'VICHADA' },
            {code: 'CO33', id:33, name: 'SANTAFE DE BOGOTA D.C' },
  ],
  loadGeo: function(browser){
    browser.asyncDataWaitedCnt++;
    // Load US county geometries
    d3.request('data/colombia.json')
      .get(function(error, data){
        var topojsonData = JSON.parse(data.response);
        topojson.feature(topojsonData, topojsonData.objects)
...
CO_States.data.forEach(function(s){
  if(s.id) CO_States.index_id[s.id] = s;
  if(s.code) CO_States.index_code[s.code] = s;
  if(s.name) CO_States.index_name[s.name] = s;
});
